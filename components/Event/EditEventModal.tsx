...
export default function EditEventModal({ visible, onDismiss, event, onUpdate }: Props) {
  ...
  const handleTimeConfirm = (time: Date) => {
    ...
    if (timePickerMode === 'start') {
      ...
      const storageFormat = `${time.getHours().toString().padStart(2, '0')}:${time.getMinutes().toString().padStart(2, '0')}`;
      setStartTimeStr(storageFormat);
